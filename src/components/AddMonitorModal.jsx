      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="my-2">
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1 mb-2">
            <Sparkles className="w-3 h-3 text-cyan-400" /> Quick Provider Presets
          </span>
          <div className="grid grid-cols-4 gap-2">
            {presetTemplates.map((tpl, idx) => (
              <button
                ...
                className="px-2.5 py-1.5 rounded-xl bg-slate-900/80 hover:bg-cyan-500/20 border border-white/10 hover:border-cyan-400/40 text-[11px] font-semibold text-slate-300 hover:text-cyan-300 transition-all text-center"
              >
                {tpl.label}
              </button>
            ))}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs mt-2">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-slate-950/80 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-slate-950/80 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-all font-mono"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-slate-950/90 border border-white/10 text-white focus:outline-none focus:border-cyan-400 transition-all"
              >
